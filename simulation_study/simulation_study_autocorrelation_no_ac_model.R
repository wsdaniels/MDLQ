...
output.file.path           <- './results/simulation_study_output_autocorrelation_no_ac_model.RData'
spike.detection.alg.path   <- 'https://raw.github.com/wsdaniels/DLQ/master/code/HELPER_spike_detection_algorithm.R'
spike.slab.regression.path <- '../code/HELPER_spike_slab_regression_variant1_independent_errors.R'
